...
- [Submit your own agents](#submit-your-own-agents)
    ...
    - [2. Custom runtime configuration](#2-custom-runtime-configuration)
    - [3. Implement `submission.py`](#3-implement-submissionpy)
    - [4. Validate locally and Submit to AICrowd](#4-validate-locally-and-submit-to-aicrowd)
- [Baselines](#baselines)
- [Local evaluation](#local-evaluation)
- [FAQ](#faq)
      - [1. Are there any hardware or time constraints?](#1-are-there-any-hardware-or-time-constraints)
      - [2. Are there any file size limit for submission?](#2-are-there-any-file-size-limit-for-submission)
      - [3. How can I speed up docker image pull?](#3-how-can-i-speed-up-docker-image-pull)
      - [4. How do windows users participate the competition?](#4-how-do-windows-users-participate-the-competition)
      - [5. How can I render/save replay locally?](#5-how-can-i-rendersave-replay-locally)
      - [6. `Error: Pack Exceeds Maximum Allowed Size`?](#6-error-pack-exceeds-maximum-allowed-size)
- [Important links](#important-links)
- [Contributors](#contributors)
- [Ricky Notes](#ricky-notes)
...
- The `map/map1` file is generated by local test rollout.
- The team ID with brackets is the `policy_id` in the beautiful table printed during/after rollout.
